  ...
  return (
    <AppShell active="/app/dashboard">
      ...
      <section className="ledger" aria-labelledby="ledger-title">
        <div className="section-heading"><h2 id="ledger-title">Heute im Blick</h2><Link href="/app/tasks">Aktionscenter öffnen →</Link></div>
        <p className="ledger-intro">Ihr tägliches Briefing aus Zahlungen, Fristen, Dokumenten und Mietprüfungen.</p>
