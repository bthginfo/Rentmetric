...
describe("Mietspiegelbewertung", () => {
  it("begrenzt die Orientierung auf die niedrigere Grenze", () => {
    const result = assessRent({
      currentColdRentCents: 70_000,
      areaSqmTimes100: 7_000,
      rangeLowCentsPerSqm: 1050,
      rangeMidCentsPerSqm: 1200,
      rangeHighCentsPerSqm: 1300,
      localCapBasisPoints: 1500,
    });
