    ...
    <form action={action} className="form-sheet">
      <div className="form-section-heading">
        ...
        <div>
          <h2>Objektadresse</h2>
          <p>
            Die Basis für Einheiten, Mietverhältnisse und regionale Mietspiegel.
          </p>
        </div>
      </div>
      <div className="form-grid">
        <Field
          name="name"
          label="Interner Objektname"
          placeholder="z. B. Kastanienhof"
        ...
        <Field
          name="street"
          label="Straße"
          placeholder="Berrenrather Straße"
        ...
        <Field
          ...
          label="Hausnummer"
          placeholder="214"
          errors={state?.fieldErrors?.houseNumber}
        />
        <Field
          name="postalCode"
          label="Postleitzahl"
      ...
      <div className="form-section-heading">
        <span>02</span>
        <div>
          <h2>Gebäude & Einheiten</h2>
          <p>Einheiten werden direkt als bearbeitbare Platzhalter angelegt.</p>
        </div>
      </div>
      <div className="form-grid">
        <Field
          ...
          inputMode="numeric"
          placeholder="1998"
          errors={state?.fieldErrors?.yearBuilt}
        />
        <Field
          name="unitCount"
          ...
          inputMode="numeric"
          defaultValue="1"
          errors={state?.fieldErrors?.unitCount}
        />
      </div>
      {state?.error && (
      ...
      <div className="form-actions">
        <Link href="/app/properties" className="btn secondary">
          Abbrechen
        </Link>
...
function Field({
  ...
  return (
    <label className={`field ${wide ? "wide" : ""}`}>
      ...
      <input
        name={name}
        required={name !== "state" && name !== "yearBuilt"}
        {...input}
      />
      {errors?.map((error) => (
