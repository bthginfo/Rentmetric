  ...
  return (
    <div className="app-shell">
      <aside className="sidebar" aria-label="Hauptnavigation">
        ...
        <div className="workspace-switch"><small>Arbeitsbereich</small><strong>{session?.organizationName || "Demo-Arbeitsbereich"}</strong></div>
        ...
        <div className="sidebar-footer"><span><span className="status-dot" /> Vorschau aktiv</span><strong>8 Einheiten · 2 Objekte</strong>Fiktive Portfoliodaten</div>
      </aside>
      <main className="app-main">
        <header className="topbar">
          ...
          <div className="top-actions"><span className="eyebrow"><span className="status-dot" /> Vorschau</span><span className="avatar" aria-label={`Profil von ${displayName}`}>{initials}</span></div>
        </header>
